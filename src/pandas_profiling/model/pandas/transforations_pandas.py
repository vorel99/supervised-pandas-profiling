...
from pandas_profiling.model.transformations import Transformer
...
class OneHotTransformerPandas(TransformerPandas):
...
class TfIdfTransformerPandas(TransformerPandas):
    """Transformer for category type variables.
...
#         self.transform_map = {
#             "Categorical": OneHotTransformerPandas,
#             "Numeric": NumTransformerPandas,
#             "Text": TfIdfTransformerPandas,
#         }
